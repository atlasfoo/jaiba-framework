...
```bash
npx skills add atlasfoo/jaiba-framework#v3.0.0 --skill jaiba-configure -g
```
...
```bash
npx skills add -y atlasfoo/jaiba-framework#v3.0.0 -g
```
...
| Aspect | Global |
|--------|--------|
| **Command** | `npx skills add -y atlasfoo/jaiba-framework#v3.0.0 --skill <skill-name>` |
