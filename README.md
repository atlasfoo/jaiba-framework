...
```bash
npx skills add atlasfoo/jaiba-framework#v3.0.1 --skill jaiba-configure -g
```
...
```bash
npx skills add -y atlasfoo/jaiba-framework#v3.0.1 -g
```
...
| Aspect | Global |
|--------|--------|
| **Command** | `npx skills add -y atlasfoo/jaiba-framework#v3.0.1 --skill <skill-name>` |
