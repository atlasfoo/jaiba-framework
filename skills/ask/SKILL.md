---
name: ask
description: Read-only Q&A mode for JAIBA. Answer questions about the codebase, active plans, or specs without changing anything. Trigger on "ask", interrogative messages like "why does the plan do X?", or "what's left?". Strictly read-only — reads, searches, explains only. Hands off to action skills when developer shifts from asking to acting.
version: 1.0.0
